...
in {
  ...
  programs.zsh = {
    envExtra = ''
      # Proxy settings
      export http_proxy="http://proxygov.ray.com:80/"
      export https_proxy="http://proxygov.ray.com:80/"
      export HTTP_PROXY="http://proxygov.ray.com:80/"
      export HTTPS_PROXY="http://proxygov.ray.com:80/"
      export all_proxy="http://proxygov.ray.com:80/"
      export ALL_PROXY="http://proxygov.ray.com:80/"
      export no_proxy="localhost,127.0.0.1,.raytheon.com,.ray.com,.rtx.com,.utc.com,.adxrt.com,.registry.npmjs.org,.eks.amazonaws.com"
      export NO_PROXY="localhost,127.0.0.1,.raytheon.com,.ray.com,.rtx.com,.utc.com,.adxrt.com,.registry.npmjs.org,.eks.amazonaws.com"

      # Used by lemminx
      export HTTP_PROXY_HOST="proxygov.ray.com"
  ...
  programs.gradle.settings = {
    "systemProp.http.proxyHost" = "proxygov.ray.com";
    "systemProp.http.proxyPort" = "80";
    "systemProp.https.proxyHost" = "proxygov.ray.com";
