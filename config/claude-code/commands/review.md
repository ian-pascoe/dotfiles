...
- **Explore** - Verify file changes match plan (Task tool with subagent_type=Explore)
- **general-purpose** - Deep analysis for complex implementations (Task tool, RECOMMENDED for: auth/security, data migrations, API contracts, performance-critical code)
