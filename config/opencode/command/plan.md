...
2. **Spawn initial research tasks to gather context**:
   ...
   - Use @explore to find all files related to the files given by the user
   - Use @oracle to understand how the current implementation works
   - If relevant, use @explore to find any existing thoughts documents about this feature
...
3. **Spawn sub-tasks for comprehensive research**:
   ...
   **For deeper investigation:**
   ...
   - @oracle - To understand implementation details (e.g., "analyze how [system] works")
   - @explore - To find similar features we can model after

   **For historical context:**
   - @explore - To find any research, plans, or decisions about this area
   - @oracle - To extract key insights from the most relevant documents
